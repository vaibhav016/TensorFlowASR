...
parser = argparse.ArgumentParser(prog="Compute max lengths file")
...
parser.add_argument("--max_lengths", type=str, default=None, help="Directory to max lenghts file")
...
ASRSliceDataset(
    ...
    stage=args.mode, shuffle=args.shuffle,
).compute_max_lengths(args.max_lengths)
